...
# Forked from https://github.com/marketplace/actions/go-coverage-report, and added -gcflags=all=-l to go test
...
go test -gcflags=all=-l ./... -coverpkg "$(go list)/..." -coverprofile "$OUT_FILE"
